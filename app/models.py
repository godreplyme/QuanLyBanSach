    ...
    with app.app_context():
        ...
        sach = [Sach(ten="Chí Phèo", tacGia="Nam Cao",
                ...
                Sach(ten="Đắc Nhân Tâm", tacGia="Dale Carnegie",
                     ...
                     soLuongTonKho=30, id_TheLoai=11, image="https://cdn0.fahasa.com/media/catalog/product/9/7/9786043949247.jpg"),
                ...
                Sach(ten="Vũ Trụ Trong Vỏ Hạt Dẻ", tacGia="Stephen Hawking",
                     ...
                     soLuongTonKho=20, id_TheLoai=1, image="https://cdn0.fahasa.com/media/catalog/product/8/9/8934974179597.jpg"),
                Sach(ten="English Grammar in Use", tacGia="Raymond Murphy",
                     ...
                     soLuongTonKho=15, id_TheLoai=2, image="https://cdn0.fahasa.com/media/catalog/product/9/7/9781108430425.jpg"),
                Sach(ten="Tôi Thấy Hoa Vàng Trên Cỏ Xanh", tacGia="Nguyễn Nhật Ánh",
                     ...
                     soLuongTonKho=25, id_TheLoai=1, image="https://cdn0.fahasa.com/media/catalog/product/n/n/nna-hvtcx.jpg"),
                Sach(ten="Nhà Giả Kim", tacGia="Paulo Coelho",
                     moTa="Một hành trình tìm kiếm ước mơ và khám phá bản thân.", donGia=100.00,
                     soLuongTonKho=12, id_TheLoai=3, image="https://cdn0.fahasa.com/media/catalog/product/i/m/image_195509_1_36793.jpg"),
                Sach(ten="Mắt Biếc", tacGia="Nguyễn Nhật Ánh",
                     moTa="Một chuyện tình đầy day dứt và thơ mộng.", donGia=65.00,
                     soLuongTonKho=18, id_TheLoai=1, image="https://cdn0.fahasa.com/media/catalog/product/n/x/nxbtre_full_06402022_014041.jpg"),
                Sach(ten="Chuyện Người Con Gái Nam Xương", tacGia="Nguyễn Dữ",
                     ...
                     soLuongTonKho=40, id_TheLoai=4, image="https://cdn0.fahasa.com/media/catalog/product/8/9/8932000130116_thanh_ly.jpg"),
                Sach(ten="Tắt Đèn", tacGia="Ngô Tất Tố",
                     moTa="Tác phẩm miêu tả cuộc sống cơ cực của người nông dân Việt Nam.", donGia=60.00,
                     soLuongTonKho=15, id_TheLoai=6, image="https://cdn0.fahasa.com/media/catalog/product/9/7/9786043947441.jpg"),
                Sach(ten="Hạt Giống Tâm Hồn", tacGia="Nhiều Tác Giả",
                     moTa="Tuyển tập những câu chuyện truyền cảm hứng và ý nghĩa.", donGia=70.00,
                     soLuongTonKho=22, id_TheLoai=2, image="https://cdn0.fahasa.com/media/catalog/product/8/9/8935086857434.jpg"),
                Sach(ten="Sống Mòn", tacGia="Nam Cao",
                     moTa="Một câu chuyện sâu sắc về cuộc sống và thân phận con người.", donGia=58.00,
                     soLuongTonKho=28, id_TheLoai=4, image="https://cdn0.fahasa.com/media/catalog/product/9/7/9786044916927.jpg"),
                Sach(ten="Lão Hạc", tacGia="Nam Cao",
                     moTa="Tác phẩm xúc động về cuộc đời một lão nông nghèo khổ.", donGia=52.00,
                     soLuongTonKho=24, id_TheLoai=4, image="https://cdn0.fahasa.com/media/catalog/product/8/9/8935236427838.jpg"),
                Sach(ten="Những Người Khốn Khổ", tacGia="Victor Hugo",
                     moTa="Câu chuyện kinh điển về lòng nhân ái và sự hi sinh.", donGia=120.00,
                     soLuongTonKho=10, id_TheLoai=7, image="https://cdn0.fahasa.com/media/catalog/product/8/9/8935086840252.jpg"),
                Sach(ten="Bến Không Chồng", tacGia="Dương Hướng",
                     ...
                     soLuongTonKho=16, id_TheLoai=5, image="https://cdn0.fahasa.com/media/catalog/product/8/9/8934974180272.jpg"),
                Sach(ten="Chiếc Lá Cuối Cùng", tacGia="O. Henry",
                     ...
                     soLuongTonKho=25, id_TheLoai=8, image="https://cdn0.fahasa.com/media/catalog/product/8/9/8936067605051.jpg"),
                Sach(ten="Quân Khu Nam Đồng", tacGia="Bình Ca",
                     moTa="Những hồi ức đẹp đẽ về một thời tuổi trẻ rực rỡ.", donGia=75.00,
                     soLuongTonKho=18, id_TheLoai=9, image="https://cdn0.fahasa.com/media/catalog/product/n/x/nxbtre_full_21352023_023516_1.jpg")
                ]

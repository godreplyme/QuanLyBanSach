...
})(), document.getElementById("navbarBlur") && "true" == document.getElementById("navbarBlur").getAttribute("data-scroll") && navbarBlurOnScroll("navbarBlur");
...
function sidebarType(e) {
    for (var t = e.parentElement.children, s = e.getAttribute("data-class"), n = document.querySelector("body"), a = document.querySelector("body:not(.dark-version)"), n = n.classList.contains("dark-version"), i = [], r = 0; r < t.length; r++) t[r].classList.remove("active"), i.push(t[r].getAttribute("data-class"));
    ...
    "bg-transparent" != s && "bg-white" != s || !a ? (o = (l = document.querySelector(".navbar-brand-img")).src).includes("logo-ct-dark.png") && (c = o.replace("logo-ct-dark", "logo-ct"), l.src = c) : (o = (l = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (c = o.replace("logo-ct", "logo-ct-dark"), l.src = c), "bg-white" == s && n && (o = (l = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (c = o.replace("logo-ct", "logo-ct-dark"), l.src = c)
}
            ...
            if (a) {
                ...
                i.querySelector("li:nth-child(" + n + ") .nav-link").onclick = function() {
                    ...
                    if (i.classList.contains("flex-column")) {
                        ...
                        r.style.transform = "translate3d(" + e + "px, 0px, 0px)", r.style.width = i.querySelector("li:nth-child(" + n + ")").offsetWidth + "px"
                    }
                }
            }
        }
...
setTimeout(function() {
    ...
    total.forEach(function(t, e) {
        ...
        var s = document.createElement("div"),
            ...
            a = (n.innerHTML = "-", s.classList.add("moving-tab", "position-absolute", "nav-link"), s.appendChild(n), t.appendChild(s), s.style.padding = "0px", s.style.transition = ".5s ease", t.querySelector(".nav-link.active").parentElement);
        if (a) {
            var i = Array.from(a.closest("ul").children),
                n = i.indexOf(a) + 1;
            let e = 0;
            if (t.classList.contains("flex-column")) {
                for (var r = 1; r <= i.indexOf(a); r++) e += t.querySelector("li:nth-child(" + r + ")").offsetHeight;
                s.style.transform = "translate3d(0px," + e + "px, 0px)", s.style.width = t.querySelector("li:nth-child(" + n + ")").offsetWidth + "px", s.style.height = t.querySelector("li:nth-child(" + r + ")").offsetHeight
            } else {
                for (r = 1; r <= i.indexOf(a); r++) e += t.querySelector("li:nth-child(" + r + ")").offsetWidth;
                s.style.transform = "translate3d(" + e + "px, 0px, 0px)", s.style.width = t.querySelector("li:nth-child(" + n + ")").offsetWidth + "px"
            }
        }
        ...
        if (!t.classList.contains("flex-column")) {
            ...
            n.indexOf(s);
            let e = 0;
            for (var a = 1; a <= n.indexOf(s); a++) e += t.querySelector("li:nth-child(" + a + ")").offsetHeight;
            var i = document.querySelector(".moving-tab");
            i.style.width = t.querySelector("li:nth-child(1)").offsetWidth + "px", i.style.transform = "translate3d(0px," + e + "px, 0px)"
        }
    }) : total.forEach(function(t, e) {
        if (t.classList.contains("on-resize")) {
            ...
            var s = t.querySelector(".nav-link.active").parentElement,
                ...
                a = n.indexOf(s) + 1;
            let e = 0;
            for (var i = 1; i <= n.indexOf(s); i++) e += t.querySelector("li:nth-child(" + i + ")").offsetWidth;
            var r = document.querySelector(".moving-tab");
            r.style.transform = "translate3d(" + e + "px, 0px, 0px)", r.style.width = t.querySelector("li:nth-child(" + a + ")").offsetWidth + "px"
        }
    })
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        ...
        for (L = 0; L < s.length; L++) s[L].classList.contains("light") && (s[L].classList.add("dark"), s[L].classList.remove("light"));
        for (L = 0; L < n.length; L++) n[L].classList.contains("light") && (n[L].classList.add("dark"), n[L].classList.remove("light"));
        for (L = 0; L < a.length; L++) a[L].classList.contains("text-white") && (a[L].classList.remove("text-white"), a[L].classList.add("text-dark"));
        for (L = 0; L < r.length; L++) !r[L].classList.contains("text-white") || r[L].closest(".sidenav") || r[L].closest(".card.bg-gradient-dark") || (r[L].classList.remove("text-white"), r[L].classList.add("text-dark"));
        for (L = 0; L < o.length; L++) o[L].classList.contains("text-white") && (o[L].classList.remove("text-white"), o[L].classList.add("text-dark"));
        for (L = 0; L < d.length; L++) d[L].classList.contains("text-white") && !d[L].closest(".sidenav") && (d[L].classList.remove("text-white"), d[L].classList.add("text-dark"));
        for (L = 0; L < u.length; L++) u[L].classList.contains("text-white") && (u[L].classList.remove("text-white"), u[L].classList.remove("opacity-8"), u[L].classList.add("text-dark"));
        for (L = 0; L < v.length; L++) v[L].classList.contains("bg-gray-600") && (v[L].classList.remove("bg-gray-600"), v[L].classList.add("bg-gray-100"));
        for (L = 0; L < y.length; L++) y[L].hasAttribute("fill") && y[L].setAttribute("fill", "#252f40");
        for (L = 0; L < m.length; L++) m[L].closest(".card.bg-gradient-dark") || (m[L].classList.remove("text-white"), m[L].classList.add("text-dark"));
        for (L = 0; L < b.length; L++) b[L].classList.remove("border-dark");
        e.removeAttribute("checked")
    } else {
        t.classList.add("dark-version");
        for (var L = 0; L < s.length; L++) s[L].classList.contains("dark") && (s[L].classList.remove("dark"), s[L].classList.add("light"));
        for (var L = 0; L < n.length; L++) n[L].classList.contains("dark") && (n[L].classList.remove("dark"), n[L].classList.add("light"));
        for (var L = 0; L < a.length; L++) a[L].classList.contains("text-dark") && (a[L].classList.remove("text-dark"), a[L].classList.add("text-white"));
        for (var L = 0; L < i.length; L++) i[L].classList.contains("text-dark") && (i[L].classList.remove("text-dark"), i[L].classList.add("text-white"));
        for (var L = 0; L < l.length; L++) l[L].classList.contains("text-dark") && (l[L].classList.remove("text-dark"), l[L].classList.add("text-white"));
        for (var L = 0; L < c.length; L++) c[L].classList.contains("text-dark") && (c[L].classList.remove("text-dark"), c[L].classList.add("text-white"));
        for (var L = 0; L < u.length; L++) u[L].classList.contains("text-secondary") && (u[L].classList.remove("text-secondary"), u[L].classList.add("text-white"), u[L].classList.add("opacity-8"));
        for (var L = 0; L < f.length; L++) f[L].classList.contains("bg-gray-100") && (f[L].classList.remove("bg-gray-100"), f[L].classList.add("bg-gray-600"));
        for (var L = 0; L < g.length; L++) g[L].classList.remove("text-dark"), g[L].classList.add("text-white");
        for (var L = 0; L < y.length; L++) y[L].hasAttribute("fill") && y[L].setAttribute("fill", "#fff");
        for (var L = 0; L < h.length; L++) h[L].classList.add("border-dark");
    ...
    let t = () => {
        ...
        e = e => {
            new IntersectionObserver(e => {
                e.forEach(e => {
                    e.isIntersecting && (t(), e = e.target, e = document.querySelector(`a[href='#${e.id}']`)) && e.classList.add("active")
                })
            }, {
                root: null,
                rootMargin: "0px",
